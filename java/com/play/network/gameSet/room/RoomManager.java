...
public class RoomManager {
    ...
    public void rejoinRoom(Room existingRoom, String playerId, Channel channel) {
        //更新房间内玩家的通道
        existingRoom.updatePlayerChannel(playerId,channel);
        System.out.println("玩家["+playerId+"]重连成功，已更新通道");
        //同步房间的基础信息
