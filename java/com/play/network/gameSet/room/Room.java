package com.play.network.gameSet.room;
...
public class Room {
   ...
   //构造函数
    ...
    public void updatePlayerChannel(String playerId,Channel newChannel){
        playerSessionManager.getByPlayerId(playerId).setPlayerChannel(newChannel);
    }
    public String getOpponentId(String playerId){
        return  roomMembers.get(0).equals(playerId)?roomMembers.get(1):roomMembers.get(0);
    }
}
