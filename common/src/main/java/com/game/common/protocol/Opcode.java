...
public class Opcode {
    ...
    public static final short LOGIN_SUCCESS               = 0x0002; // 登录成功响应
    public static final short LOGIN_FAILED                = 0x0003; // 登录失败响应
    public static final short LOGOUT_OPCODE               = 0x0008; // 退出登录请求
    ...
    public static final short REGISTER_FAILED             = 0x0009; // 注册失败响应
    public static final short REGISTER_SUCCESS            = 0x000A; // 注册失败响应
    ...
    public static final short RECONNECT_OPCODE = 0x1100;
    public static final short RECONNECT_FAILED = 0x1101;
    public static final short RECONNECT_SUCCESS =0x1102;

    public static final short TOKEN_EXPIRED = 0x1103;//token过期的情况
    public static final short TOKEN_REFRESH_REQUEST = 0x1104;//token刷新请求
    public static final short TOKEN_REFRESH_RESPONSE = 0x1105;//token刷新回应
    public static final short TOKEN_REFRESH_FAILED = 0x1106;//token刷新失败
    public static final short MATCHMAKING_OPCODE = 0x1107;//进行匹配申请
    public static final short CANCEL_MATCHMAKING_OPCODE = 0x1108;
    public static final short GAME_READY_OPCODE = 0x1109;
}